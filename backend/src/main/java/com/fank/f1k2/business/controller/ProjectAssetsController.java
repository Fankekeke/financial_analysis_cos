 ...
 */
@RestController
@RequestMapping("/business/project-assets")
@RequiredArgsConstructor(onConstructor = @__(@Autowired))
public class ProjectAssetsController {

    private final IProjectAssetsService bulletinInfoService;
     ...
     */
    @GetMapping("/page")
    public R page(Page<ProjectAssets> page, ProjectAssets queryFrom) {
     ...
     * 新增产品管理
     *
     * @param addFrom 产品管理对象
     * @return 结果
     */
    @PostMapping
    public R save(ProjectAssets addFrom) {
     ...
     * 修改产品管理
     *
     * @param editFrom 产品管理对象
     * @return 结果
     */
    @PutMapping
    public R edit(ProjectAssets editFrom) {

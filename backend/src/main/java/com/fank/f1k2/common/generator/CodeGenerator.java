package com.fank.f1k2.common.generator;
...
public class CodeGenerator {
    ...
    // 数据库 URL
    private static final String URL = "jdbc:mysql://127.0.0.1:3306/financial_analysis?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    // 数据库驱动
    ...
    // @author 值
    private static final String AUTHOR = "FanK fan1ke2ke@gmail.com（悲伤的橘子树）";
    // 包的基础路径
    private static final String BASE_PACKAGE_URL = "com.fank.f1k2";
    // xml文件路径
    ...
    public static void main(String[] args) {
        ...
        packageConfig.setModuleName("business");

          ...
          <div :class="advanced ? null: 'fold'">
            ...
            <a-col :md="6" :sm="24">
              <a-form-item
                ...
                :labelCol="{span: 5}"
                :wrapperCol="{span: 18, offset: 1}">
                <a-input v-model="queryParams.accountType"/>
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="24">
              <a-form-item
...
import BulletinAdd from './AccountsAdd.vue'
import BulletinEdit from './AccountsEdit.vue'
      ...
      return [{
        ...
        customRender: (text, row, index) => {
          if (text === '1') {
            ...
            return <a-tag color="red">注销</a-tag>
          }
        }
      }, {
        title: '用户名',
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/business/accounts/' + ids).then(() => {

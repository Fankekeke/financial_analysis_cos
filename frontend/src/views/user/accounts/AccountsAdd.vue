  ...
  <a-modal v-model="show" title="新增存款账户" @cancel="onClose" :width="650">
    ...
    <a-form :form="form" layout="vertical">
      <a-row :gutter="20">
        ...
        <a-col :span="12">
          <a-form-item label='账户类型' v-bind="formItemLayout">
            <a-select v-decorator="[
              ...
              <a-select-option value="投资">投资</a-select-option>
            </a-select>
          </a-form-item>
        </a-col>
        <a-col :span="12">
        ...
        <a-col :span="24">
          <a-form-item label='实时余额' v-bind="formItemLayout">
            <a-input-number
              v-decorator="[
                'balance',
                { rules: [{ required: true, message: '请输入实时余额!' }] }
              ]"              style="width: 100%"
              :precision="2"
              :min="0"
              placeholder="请输入余额"

...
import BulletinAdd from './SavingGoalsAdd.vue'
import BulletinEdit from './SavingGoalsEdit.vue'
...
export default {
  ...
  methods: {
    ...
    batchDelete1 () {
      this.$get('/business/saving-goals/batchEditSupplierName').then((r) => {
      })
    },
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/business/saving-goals/' + ids).then(() => {
    ...
    fetch (params = {}) {
      ...
      this.$get('/business/saving-goals/page', {
        ...params
      }).then((r) => {

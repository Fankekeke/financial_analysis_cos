...
import BulletinAdd from './BudgetsAdd.vue'
import BulletinEdit from './BudgetsEdit.vue'
...
export default {
  ...
  methods: {
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/business/budgets/' + ids).then(() => {
    ...
    fetch (params = {}) {
      ...
      this.$get('/business/budgets/page', {
        ...params
      }).then((r) => {

<template>
  <a-modal v-model="show" title="修改存款账户" @cancel="onClose" :width="800">
    ...
    <a-form :form="form" layout="vertical">
      <a-row :gutter="20">
        <a-col :span="12">
          <a-form-item label='存款账户标题' v-bind="formItemLayout">
            <a-input v-decorator="[
            'title',
        ...
        <a-col :span="12">
          <a-form-item label='存款账户类型' v-bind="formItemLayout">
            <a-select v-decorator="[
              'type',
              { rules: [{ required: true, message: '请输入存款账户类型!' }] }
              ]">
              <a-select-option value="1">系统存款账户</a-select-option>
        ...
        <a-col :span="12">
          <a-form-item label='存款账户状态' v-bind="formItemLayout">
            <a-select v-decorator="[
              'rackUp',
              { rules: [{ required: true, message: '请输入存款账户状态!' }] }
              ]">
        ...
        <a-col :span="24">
          <a-form-item label='存款账户内容' v-bind="formItemLayout">

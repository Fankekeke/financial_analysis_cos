...
import BulletinAdd from './TransactionsAdd.vue'
import BulletinEdit from './TransactionsEdit.vue'
...
export default {
  ...
  methods: {
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/business/transactions/' + ids).then(() => {
    ...
    fetch (params = {}) {
      ...
      this.$get('/business/transactions/page', {
        ...params
      }).then((r) => {

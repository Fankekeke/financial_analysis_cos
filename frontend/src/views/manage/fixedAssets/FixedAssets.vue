...
import BulletinAdd from './FixedAssetsAdd.vue'
import BulletinEdit from './FixedAssetsEdit.vue'
...
export default {
  ...
  methods: {
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/business/fixed-assets/' + ids).then(() => {
    ...
    fetch (params = {}) {
      ...
      this.$get('/business/fixed-assets/page', {
        ...params
      }).then((r) => {
